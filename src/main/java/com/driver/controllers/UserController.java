...
public class UserController {
    ...
    public ResponseEntity<User> registerUser(@RequestParam String username, @RequestParam String password, @RequestParam String countryName){
        ...
        User user=null;
        try{
            user = userService.register(username, password, countryName);
        }
        catch(Exception e){
